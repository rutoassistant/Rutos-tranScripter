...
## Application to JAVS-tranScripter

JAVS-tranScripter applies these principles to programming language understanding:

| SHRDLU | JAVS-tranScripter |
|--------|-------------------|
...
- [[JAVS-tranScripter]] — Current implementation status
